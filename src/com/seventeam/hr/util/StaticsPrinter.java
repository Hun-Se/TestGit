...
import com.seventeam.hr.dao.CityDAO;
...
public class StaticsPrinter {
	// 사원검색시 정보 출력
	public static void printEmpListByName() throws Exception {
		while (true) {
			...
			if (empName.equals("끝")) {
				...
				for (Emp emp : list) {
					System.out.println("---------------------------------------------------------------------------");
					System.out.println("연봉: " + emp.getSalary() + ", 입사일: " + emp.getHireDate() + ", 부서장번호" + emp.getManagerId()
							+ ", 부서번호 " + emp.getDepartmentId());
					System.out.println("---------------------------------------------------------------------------");
				}
			}
		}
	...
	// 입사 관련 출력
	public static void printInfoByHireYear() throws Exception{
		while (true) {
			Scanner sc = new Scanner(System.in);
	...
	// 도시 정보 출력
	public static void printCityCount(String cityName) throws Exception {
		CityStatistics city = CityDAO.getCityListByCity(cityName);
		System.out.println("---------------------------------------------------------------------------");
		System.out.println("전체 도시 개수" + city.getCount());
		System.out.println("---------------------------------------------------------------------------");
	}
	...
	public static void printEmpInfoByManagerName() {
		...
		while (!managerName.equals("끝")) {
			try {
				...
				System.out.println("---------------------------------------------------------------------------");
				for (Emp emp : list) {
					System.out.println("사원이름: " + emp.getName() + ", 연봉: " + emp.getSalary() + ", 입사일: " + emp.getHireDate()
							+ ", 부서명: " + emp.getDepartmentName());
				}
				System.out.println("---------------------------------------------------------------------------");
				System.out.print("부서장 이름: ");
